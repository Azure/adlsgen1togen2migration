# This script gets the Gen1 files details and save it in local as txt file
# It uses Export-AzDataLakeStoreChildItemProperty function to get file details


# connect to azure using service principal and tenantId to use
